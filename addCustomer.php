    ...
    <div class="main p-3">
        <div class="container">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($stmt->execute()) {
                    echo "<div class='alert alert-success mt-4' id='success-alert'>Customer added successfully!</div>";
                } else {
                    echo "<div class='alert alert-danger mt-4' id='danger-alert'>Error adding customer: " . $stmt->error . "</div>";
                }
